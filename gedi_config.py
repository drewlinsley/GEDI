...
class GEDIconfig(object):  # at some point use pjoin throughout
    def __init__(self):
        ...
        self.home_dir = '/Users/drewlinsley/Documents/GEDI_images'  # Arbitrary home directory
        ...
        self.src_dir = '/Users/drewlinsley/Documents/GEDI_images'  # Project source directory
