...
class Vgg16:
    ...
    def build(self, rgb, output_shape = None, train_mode=None, batchnorm=None):
        ...
        self.conv5_1 = self.conv_layer(self.pool4, 512, 512, "conv5_1", batchnorm)
        self.conv5_2 = self.conv_layer(self.conv5_1, 512, 512, "conv5_2", batchnorm)
        self.conv5_3 = self.conv_layer(self.conv5_2, 512, 512, "conv5_3", batchnorm)
    ...
    def conv_layer(self, bottom, in_channels, out_channels, name, batchnorm=None):
    ...
    def get_var(self, initial_value, name, idx, var_name):
        ...
        if self.trainable:
            var = tf.get_variable(name=var_name,initializer=value) #get_variable, change the boolian to numpy
        else:
